...
public class Cell {
    ...
    private static final ImageIcon CROSS_ICON = new ImageIcon(Cell.class.getResource("/TicTacToeAI2/cat.gif"));
    private static final ImageIcon NOUGHT_ICON = new ImageIcon(Cell.class.getResource("/TicTacToeAI2/doggie.gif"));
